...
CQueue::CQueue(release_data_fn data_rel_fn, void *user_data)
{
    pthread_mutex_init(&m_lock, NULL);
    clist_init(&m_head.list);
    m_size = 0;
...
void* CQueue::dequeue(match_fn_data match, void *match_data)
{
    q_node* node = NULL;
    struct clist *head = NULL;
    struct clist *pos = NULL;
...
void CQueue::flushNodes(match_fn match)
{
    q_node* node = NULL;
    struct clist *head = NULL;
    struct clist *pos = NULL;
...
void CQueue::flushNodes(match_fn_data match, void *match_data)
{
    q_node* node = NULL;
    struct clist *head = NULL;
    struct clist *pos = NULL;
